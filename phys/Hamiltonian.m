...
%uncoupled Hamiltonian for ground and excited states
    ...
    H.uHg=atom.pm.Ag*H.uIS - H.umug(:,:,3)*B; %uncoupled Hamiltonian
    H.uHe=atom.pm.Ae*H.uIJ - H.umue(:,:,3)*B;%Hamiltonian without quadrupole interaction

    if atom.qn.J>1/2&&atom.qn.I>1/2
        H.uHe = H.uHe+atom.pm.Be*(3*H.uIJ^2+1.5*H.uIJ-atom.qn.I*(atom.qn.I+1)*atom.qn.J*(atom.qn.J+1)*eye(atom.sw.ge))...
