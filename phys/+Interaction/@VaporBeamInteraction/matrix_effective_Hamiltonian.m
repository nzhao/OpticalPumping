...
%   Detailed explanation goes here
    ...
    switch obj.option
        case {'high-pressure', 'doppler-average'}
            denom = Interaction.DenominatorMat(obj.vapor, obj.beam, obj.option);
        case {'vacuum', 'vacuum-full', 'vacuum-ground', 'vacuum-ground-rate'}
