...
figure;
subplot(2,3,1); plot(timeList,popE_t, '.-', timeList,popE_t_QS, 'o', timeList,popE_t_GS, '+')
subplot(2,3,2); plot(timeList,popG_t, '.-', timeList,popG_t_QS, 'o', timeList,popG_t_GS, '+')
subplot(2,3,3); plot(timeList,sum(popG_t,1)+sum(popE_t, 1), '.-', timeList,sum(popG_t_QS,1)+sum(popE_t_QS, 1), 'o', timeList,sum(popG_t_GS,1)+sum(popE_t_GS, 1), '+')

subplot(2,3,4);plot(timeList,cohE_t, '.-', timeList,cohE_t_QS, 'o', timeList,cohE_t_GS, '+')
subplot(2,3,5);plot(timeList,cohG_t, '.-', timeList,cohG_t_QS, 'o', timeList,cohG_t_GS, '+')
subplot(2,3,6);plot(timeList,cohEG_t, '.-', timeList,cohEG_t_QS, 'o', timeList,cohEG_t_GS, '+')
